...
mappings_one_to_one = [
  ...
  # NIHPMI-574 Personal & Family Hx, SDOH, Winter Minute Surveys, and Digital Health Consent
  ...
  {'hp':'Digital Health Consent', 'api':'digitalHealthSharingStatus', 'func':'api2hp_basic'},
]

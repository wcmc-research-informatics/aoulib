...
def disp_keys(api_spec):
  '''Output key IDs and creation dates to stdout. Asterick (*)
...
def create_new_key_to_file(api_spec):
  ...
  key_info = create_new_key(api_spec)
...
def cycle_keys(api_spec):
  ...
  new_key_info = create_new_key(api_spec)
